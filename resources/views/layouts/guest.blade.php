...
<div class="min-h-screen flex flex-col items-center justify-center px-5 py-12">
    <a href="{{ route('home') }}" wire:navigate class="flex items-center gap-3 mb-6">
        ...
        <span class="font-serif text-3xl text-ink-900 tracking-tight">Re<span class="text-sun-400">·</span>Life</span>
    </a>
    ...
    <p class="mt-6 font-hand text-[20px] text-clay-500">her dostun bir hikâyesi var 🌿</p>
</div>
